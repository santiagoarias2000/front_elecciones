const ApiBack = {
  ...
  COMBOBOX_LOCATION: "/api/public/municipio/localidad/combito",
  ...
  ALCALDIA_LOCALIDAD:"/api/private/alcaldia/localidad",
  ...
  CONCEJO_LOCALIDAD:"/api/private/concejo/localidad",
