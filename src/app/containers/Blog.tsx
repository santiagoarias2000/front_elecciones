...
export const Blog = () => {
  return (
    <main id="main" className="main containner_blog">
      <div className="side_bar"></div>
      <section className="img">
        <div className="color-yellow" />
        <div className=" rounded title_blog ">
          <div className="col-md-6 ">
            <h1 className="display-4 fst-italic title">
              Blog Guía Electoral de Colombia
            </h1>
            <p className="lead my-3 text">
              aca va a estar una pequeña descripcion del blog || Lorem, ipsum
              dolor sit amet consectetur adipisicing elit. Minus nesciunt
              dolorem ex voluptatibus qui perferendis, laudantium repudiandae
            </p>
            <p className="lead mb-0">
              <a href="#" className="link_blog text2">
                VER RESULTADOS DE ELECIONES
              </a>
            </p>
          </div>
        </div>
              ...
              <div className="col-md-12">
                <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                  <div className="col p-4 d-flex flex-column position-static">
                    <h3 className="mb-0">Gustavo Petro</h3>
                    <div className="mb-1 text-muted">Marzo 4</div>
                    <p className="mb-auto">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Suscipit at aperiam repudiandae. Alias suscipit aut
                      asperiores dolorem.
                    </p>
                  </div>
          ...
          <div className="col-6">
            <section>
              <div className="col-md-12">
                <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                  <div className="col p-4 d-flex flex-column position-static">
                    <h3 className="mb-0">Ivan Duque</h3>
                    <div className="mb-1 text-muted">Marzo 4</div>
                    <p className="mb-auto">
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                      Quidem quo, culpa itaque temporibus quae mollitia, vel
                      consectetur veniam quas quod qui molestias.
                    </p>
                  </div>
                  <div className="col-auto d-none d-lg-block">
                    <img
      ...
      <section className="banner_pubilic">
        <img src={banner} alt="Imagen publicitaria de hit data" />
      </section>
        ...
        <div className="row g-5">
          <div className="col-md-8">
            ...
            <article className="blog-post">
              ...
              <img src={bannerpeque} alt="" className="banner2"/>
              <h2>Blockquotes</h2>
          ...
          <div className="col-md-4">
            <div className="position-sticky" style={{ top: "2rem" }}>
              ...
              <div className="p-4">
                ...
                <img src={verticalbanner} alt="" className="banner2" />
