        ...
        <div className="container containner_blog" data-aos="fade-up">
          <div className="row">
            ...
            <article className="entry">
                ...
                <div className="entry-content">
                  <p>
                    El candidato de izquierda Gustavo Petro ganó las elecciones
                    en Colombia al lograr más de 11 millones de votos en la
                    segunda vuelta presidencial realizada el 19 de junio, según
                    los resultados de la Registraduría. Asumirá su cargo este
                    domingo.
                  </p>
                </div>
              </article>
            ...
            <article className="entry">
                ...
                <div className="entry-content">
                  <p>
                    ...
                    la política colombiana, de hampones, de bandoleros. Dijiste
                    que Petro quería matarte
                  </p>
                </div>
              </article>
            </div>
            ...
            <article className="entry">
                ...
                <h2 className="entry-title text_title_respo">
                  Elecciones: así puede consultar su puesto de votación este 19
                  de junio
                </h2>
                ...
                <div className="entry-content">
                  <p>
                    ...
                    elecciones para escoger al nuevo presidente de la República,
                    quien empezará su mandato el 7 de agosto, en reemplazo de
                    Iván Duque. Gustavo Petro y Rodolfo Hernández son los dos
                    candidatos que estarán en el tarjetón del balotaje, junto a
