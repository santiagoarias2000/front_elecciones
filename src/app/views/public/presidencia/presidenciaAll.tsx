...
export const PresidenciaAll = () => {
  ...
  return (
    <main id="main" className="main">
      <section id="primeraVuelta" className="primeraVuelta">
        <img
          src={presidencia}
          style={{ width: "100%", maxHeight: "80%", marginTop: "1vw" }}
            ...
            <div className="dropdown">
              ...
              >
                <div className="text-center">
                  ...
                  <a
                    type="button"
                    className="buttonBack d-inline buttonBack-primary"
                    href={"/presidencia/#segundaVuelta"}
      ...
      <section id="segundaVuelta" className="segundaVuelta">
        <div className="col-lg-12" style={{ color: "#052851 !important" }}>
          <div className="cardBorder card">
            <div className="container-fluid display-flex justify-content-center container_title">
              <div className="text-center">
              ...
              >
                <div className="text-center">
                  ...
                  <a
                    type="button"
                    className="buttonBack d-inline buttonBack-primary"
                    href={"/presidencia/#primeraVuelta"}
                    style={{marginLeft:"10px"}}
                  >
